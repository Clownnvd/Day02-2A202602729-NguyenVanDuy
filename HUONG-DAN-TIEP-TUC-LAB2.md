...
| [`02-group-problem-statement/group-report.md`](02-group-problem-statement/group-report.md) | Phase 3–6: nhóm hội tụ candidates, kiểm chứng, research, workflow, Problem Statement v0/v1, so Rule/Workflow/Agent và quyết định Go/Not Yet/No-Go. Mỗi người đưa **cùng bản nhóm cuối** vào repo cá nhân. | Google Doc chung ghi **5 thành viên, 13 candidate, chọn món ăn**, shortlist/score và `Not Yet`; Duy xác nhận lớp chiều nay chia nhóm 5. Interview/survey trong Doc được tab khác gọi là **kịch bản minh họa**, nên bản repo giữ nhãn chưa xác minh. |
| [`03-individual-reflection/reflection.md`](03-individual-reflection/reflection.md) | Phase 7: reflection cá nhân 8–12 câu về vai trò, pitch/challenge, cách dùng AI, điều sửa sau phản biện và bài học. | Đã có **bản nháp AI 10 câu** theo vai trò Duy xác nhận, Dương pitching và bài học Duy nêu. Đây chưa phải reflection cuối; Duy phải tự đọc, sửa bằng trải nghiệm và cách diễn đạt của mình theo worksheet. |
...
2. **Xác nhận lại nhật ký hội tụ trong Google Doc với nhóm.** Doc đã ghi 13 candidates của 5 người, score 31/27/22 và chọn món ăn; Duy xác nhận lớp chiều nay chia nhóm 5. Cần từng thành viên xác nhận phần mình pitch/challenge, lý do chọn và disagreement thật.
...
Phase 1 đã có 8 vấn đề theo bốn lăng kính; Phase 2 đã có top 3 Problem Cards cá nhân. Fiprove không được đưa vào scan. File nhóm đã chuyển sang vấn đề **chọn món ăn khi bận** từ Google Doc chung: Duy xác nhận lớp chiều nay chia nhóm 5, Doc có 13 candidates; Dương là người pitching, Duy là trưởng nhóm/điều phối/research. Phần interview/survey trong tab “Thẻ 2” được ghi là kịch bản minh họa nên bản repo giữ nhãn chưa xác minh. Số `10 → ≤5 phút` chỉ là giả định/mục tiêu pilot. Reflection có bản nháp AI 10 câu theo bài học Duy nêu — phải tự đọc và viết lại trước khi nộp. Hãy kiểm yêu cầu, chỉ ra chỗ thiếu, chỉnh theo dữ liệu thật tôi cung cấp. Đừng bịa phỏng vấn, số phút, đồng thuận hay đóng góp cá nhân. Cuối cùng giúp kiểm repo public/main và hướng dẫn dán link vào đúng VLearn Lab 2.
```
