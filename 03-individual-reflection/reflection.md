...
| Workflow | Chuyển bản chọn món trong Google Doc thành luồng có lọc giá/ETA trước, gom món cũ/bộ lọc/gợi ý rồi hiện tối đa 3 món. | Chưa có menu cập nhật để chứng minh giá/ETA ngoài đời; người dùng vẫn phải kiểm. | Tôi đã sửa/hỏi lại bước nào? |
| Research | Tìm nguồn chính thức GrabFood, Grab AI Assistant và Uber Eats để kiểm sản phẩm đã có. | AI có thể nói sai rằng chưa ai gợi ý món có giải thích; Grab đã công bố tính năng tương tự. | Tôi đã tự mở/so nguồn nào? |
| Problem Statement | Làm rõ actor bận, bottleneck chốt món và mục tiêu giảm thời gian sau khi đo `T0`. | Con số 10 phút/lần trong Doc chỉ là ước lượng, chưa phải baseline nhóm. | Tôi đã đo hoặc bỏ giả định nào? |
| Rule / Workflow / Agent | Đặt bộ lọc/món quen làm baseline, AI chỉ hỗ trợ hiểu câu tự do/xếp giải thích nếu cần; không tự đặt món. | Rule có thể đã đủ cho nhiều ca, phải thử trước khi nói cần AI. | Vì sao tôi hoặc nhóm chọn mức cuối? |
| Decision | Bản Doc ghi `Not Yet` vì cần dữ liệu người dùng và menu thật. | Interview/survey trong tab “Thẻ 2” là kịch bản minh họa, không thể dùng làm bằng chứng. | Quyết định thật sau kiểm chứng là gì? |
